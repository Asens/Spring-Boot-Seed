 ...
 * @since 1.2
 */
public class ReLogoutFilter extends AdviceFilter {

    private static final Logger log = LoggerFactory.getLogger(ReLogoutFilter.class);
     ...
     * returns the static configured property, but this method may be overridden
    ...
    public String getRedirectUrl(ServletRequest request) {
        ...
        if(StringUtils.isNotBlank(req.getParameter("redirectUrl")))
            return req.getParameter("redirectUrl");
        return redirectUrl;
    }
